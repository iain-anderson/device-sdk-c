...
#define DEFAULTSECPATH "/v1/secret/edgex/%s"
...
iot_data_t *edgex_config_defaults (const iot_data_t *driverconf, const char *svcname)
{
  ...
  iot_data_string_map_add (result, "SecretStore/RetryWaitPeriod", iot_data_alloc_string ("1s", IOT_DATA_REF));
  iot_data_string_map_add (result, "SecretStore/AdditionalRetryAttempts", iot_data_alloc_ui32 (10));
